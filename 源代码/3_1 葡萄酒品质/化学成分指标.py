...
# 氯化物浓度对评分影响
plt.suptitle('氯化物浓度对评分的影响', y=1.00, fontsize=16, fontproperties=my_font)  # 总标题
"""红"""
plt.subplot(1, 2, 1)
sns.boxplot(x=dfr['quality'], y=dfr['chlorides'])
plt.xlabel('红葡萄酒评分', fontsize=12, fontproperties=my_font)
plt.ylabel('氯化物浓度', fontsize=12, fontproperties=my_font)
"""白"""
plt.subplot(1, 2, 2)
...
# 硫酸盐浓度对评分影响
plt.suptitle('硫酸盐浓度对评分的影响', y=1.0, fontsize=16, fontproperties=my_font)  # 总标题
"""红"""
plt.subplot(1, 2, 1)
sns.boxplot(x=dfr['quality'], y=dfr['sulphates'])
plt.xlabel('红葡萄酒评分', fontsize=12, fontproperties=my_font)
plt.ylabel('硫酸盐浓度', fontsize=12, fontproperties=my_font)
"""白"""
plt.subplot(1, 2, 2)
...
# 游离二氧化硫占总二氧化硫比重
plt.suptitle('游离二氧化硫占总二氧化硫比重分布情况', y=1.0, fontsize=16, fontproperties=my_font)  # 总标题
"""红"""
plt.subplot(1, 2, 1)
...
plt.xlabel('红葡萄酒游离二氧化硫占比', fontsize=12, fontproperties=my_font)
...
temp['precent'] = temp.apply(lambda x: x['free sulfur dioxide'] / x['total sulfur dioxide'], axis=1)  # 计算占比
temp['precent'].hist(bins=100, color=color[0])
plt.xlabel('白葡萄酒游离二氧化硫占比', fontsize=12, fontproperties=my_font)
plt.ylabel('频数', fontsize=12, fontproperties=my_font)
plt.show()

# 游离二氧化硫占比对评分影响
plt.suptitle('游离二氧化硫占总二氧化硫比重对评分的影响', y=1.0, fontsize=16, fontproperties=my_font)  # 总标题
"""红"""
plt.subplot(1, 2, 1)
...
plt.xlabel('红葡萄酒评分', fontsize=12, fontproperties=my_font)
plt.ylabel('游离二氧化硫占比', fontsize=12, fontproperties=my_font)
"""白"""
plt.subplot(1, 2, 2)
...
# 二氧化硫总量对评分影响
plt.suptitle('二氧化硫总量对评分的影响', y=1.0, fontsize=16, fontproperties=my_font)  # 总标题
"""红"""
plt.subplot(1, 2, 1)
sns.boxplot(x=dfr['quality'], y=dfr['total sulfur dioxide'])
plt.xlabel('红葡萄酒评分', fontsize=12, fontproperties=my_font)
plt.ylabel('二氧化硫总量', fontsize=12, fontproperties=my_font)
"""白"""
plt.subplot(1, 2, 2)
